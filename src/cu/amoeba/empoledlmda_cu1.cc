   ...
   real aewald, real elambda)
{
   ...
   int mutk;
   real frcxi, frcyi, frczi, dfrcxi, dfrcyi, dfrczi, trqxi, trqyi, trqzi, dltrqxi, dltrqyi, dltrqzi;
   real frcxk, frcyk, frczk, dfrcxk, dfrcyk, dfrczk, trqxk, trqyk, trqzk, dltrqxk, dltrqyk, dltrqzk;
